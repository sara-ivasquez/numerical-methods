...
import { multipleRoots2 } from '../../methods/multipleRoots2'
import './MethodForm.css'

const HELP = (
  <>
    <p>El <strong>método de Raíces Múltiples 2</strong> detecta automáticamente la multiplicidad usando f, f' y f''.</p>
    <p><strong>Fórmula:</strong> Xₙ₊₁ = Xₙ - f(Xₙ)·f'(Xₙ) / [f'(Xₙ)² - f(Xₙ)·f''(Xₙ)]</p>
    <p><strong>Ventaja:</strong> No necesitas conocer la multiplicidad de antemano.</p>
    <p><strong>Nota:</strong> Las derivadas se calculan automáticamente.</p>
...
const COLUMNS = [
  ...
  { key: 'fxn',    label: 'f(Xn)' },
  { key: 'dfxn',   label: "f'(Xn)" },
  { key: 'd2fxn',  label: "f''(Xn)" },
  { key: 'xn1',    label: 'Xn+1' },
  { key: 'error',  label: 'Error' },
]

export default function MultipleRoots2() {
  ...
  return (
    <MethodLayout title="Raíces Múltiples 2" category="Búsqueda de Raíces" helpText={HELP}>
